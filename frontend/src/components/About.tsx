...
import { MapPin, GraduationCap, Briefcase, Award, Zap } from 'lucide-react';
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { icon: Briefcase, label: 'Current Role', value: 'DevOps Engineer at Makunai Global Technologies', color: 'text-purple-400' },
