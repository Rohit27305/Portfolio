...
import { Award, Trophy, Star, ChevronLeft, ChevronRight, Calendar } from 'lucide-react';
    ...
    <section id="certifications" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            {[
              { label: "Certifications", value: "10+", icon: <Award className="w-6 h-6" /> },
              { label: "Projects Completed", value: "15+", icon: <Star className="w-6 h-6" /> },
              { label: "Months Experience", value: "12+", icon: <Trophy className="w-6 h-6" /> },
              { label: "Technologies Used", value: "20+", icon: <Award className="w-6 h-6" /> }
            ].map((stat, index) => (
              <motion.div
                key={index}
