  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Terraform", description: "Infrastructure as Code (IaC) for cloud resources", level: 85 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Networking", description: "Core Networking Concepts", level: 92 },
        ...
        >
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {[
                'Kubernetes', 'Docker', 'AWS', 'Digital Ocean' , 'Helm', 'Prometheus', 'Grafana', 
                'GitHub Actions', 'SonarQube', 'Cloudflare' , 'Linux', 'Python', 'Bash', 'YAML'
              ].map((tech, index) => (
                <motion.div
                  key={tech}
